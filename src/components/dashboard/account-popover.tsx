...
export const AccountPopover: FC<AccountPopoverProps> = (props) => {
  ...
  const user = {
    name: userName,
    Organization: isOrganizationData?.organization?.name || "",
  };
  ...
  return (
    ...
    >
      ...
      <Box sx={{ my: 1 }}>
        ...
        <Divider />
        {isOrganizationData && isOrganizationData.isSuperUser === false ? (
          ...
          <NextLink href='/administration/changePassword' passHref>
          <MenuItem component="a">
            <ListItemIcon>
              <LockResetIcon fontSize="small" />
            </ListItemIcon>
