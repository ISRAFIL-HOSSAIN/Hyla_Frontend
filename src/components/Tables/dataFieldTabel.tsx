...
export const DataFieldTabel: FC<ListTableProps> = (props) => {
  const {
    data,
    dataCount,
    onPageChange,
  ...
  const handleDeleteConfirmation = async () => {
    try {
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}aisDataFiled/delete/${selectedDataForDeletion._id}`;
  ...
  const handleActivate = async () => {
    try {
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}aisDataFiled/active/${selectedDataForActivation._id}`;
  ...
  const handleDeactivateConfirmation = async () => {
    try {
      ...
      const apiUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}aisDataFiled/deactivate/${selectedDataForActivation._id}`;
                          ...
                          return (
                            <TableRow hover key={data._id}>
                              <TableCell>
                                ...
                                >
                                  <Box sx={{ ml: 1 }}>{data.fieldName}</Box>
                                </Box>
                              </TableCell>
                              ...
                              <TableCell align="right">
                                <NextLink
                                  href={`/administration/dataField/${data._id}`}
                                  passHref
                                >
