...
import { PortTabel } from "src/components/Tables/portTabel";
  interface Filters {
    query?: string;
  ...
  const PortList: NextPage = () => {
    ...
    const getData = useCallback(async () => {
      try {
        ...
        const apiUrl =`${process.env.NEXT_PUBLIC_API_BASE_URL}ports/getAll`;
          ...
          <Container maxWidth="xl">
            <Box sx={{ mb: 4 }}>
              <Grid container justifyContent="space-between" spacing={3}>
                <Grid item>
                  <Typography variant="h4">Port Details</Typography>
                </Grid>
                <Grid item>
                  <NextLink
                    href="/administration/port/create"
                    passHref
                  >
                    <Button
  ...
  PortList.getLayout = function (page) {
    return (
      <AuthGuard>
